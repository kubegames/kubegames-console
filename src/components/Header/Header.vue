<template>
  <v-app-bar
    ...
    <v-toolbar-title>
      <div class="text-h5">Welcome {{ nick }} !</div>
    </v-toolbar-title>
    <v-spacer></v-spacer>
    <Search />
    ...
    <v-menu
      ...
      nudge-bottom="10">
        ...
        <v-list >
          <!-- <div class="text-h5 grey--text text--darken-3 px-4 pt-4">Welcome</div>
          <div class="subtitle-2 primary--text font-weight-regular px-4">{{ nick }}</div> -->
          <v-list-item-group color="primary">
            <v-list-item
...
<script>
  ...
  export default {
    ...
    components: { Search },
    data: () => ({
      nick:store.state.user.info.nick,
      config,
      searchCollapse: true,
      notifications: [
