<template>
  ...
  >
    <!-- <div class="v-list">
      <a class="v-list-item v-list-item--link grey--text text-sm-h6" target="_blank">
        <v-img src="@/assets/kubegames.png"></v-img> 
      </a>
    </div> -->
    <v-list>
      <v-list-item class="v-list-item v-list-item--link grey--text text-sm-h6">
        <v-list-item-avatar>
          <v-img src="@/assets/kubegames.png"></v-img>
        </v-list-item-avatar>
        <v-list-item-title>Kubegames</v-list-item-title>
      </v-list-item>
      <v-divider></v-divider>
    </v-list>
    ...
    data(){
      return {
        items: [
          ...
          { title: 'Game', icon: ' mdi-cards', link: '/game' },
          { divider: true },
          { heading: 'System' },
          {
            title: 'UI Elements',
